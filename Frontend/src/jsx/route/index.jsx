...
// ✅ Protected Route - bina login ke andar nahi jaane dega
...
// ✅ Public Route - already logged in hai toh login page nahi dikhega
    ...
    return (
        <>
            <Routes>
                ...
                {/* ✅ Login page - already logged in toh dashboard pe */}
                <Route
                    path="/login"
                    element={
                        <PublicRoute>
                ...
                {/* ✅ Error page - sab dekh sakte hain */}
                <Route path="/error-400" element={<Error400 />} />

                {/* ✅ Saare protected routes - bina token ke nahi khulenge */}
                <Route
                    element={
                        <ProtectedRoute>
                            <MainLayout />
                ...
                {/* ✅ Koi bhi unknown URL - login pe bhejo */}
