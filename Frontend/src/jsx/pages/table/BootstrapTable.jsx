...
import avatar3 from "../../../assets/images/user.jpg";
    ...
    <Fragment>
      ...
      <Row>
        ...
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>Worldnic</Card.Title>
            </Card.Header>
            <Card.Body>
              <Table responsive className="text-nowrap">
                <thead>
                  <tr>
                    <th className="width50 ">
                      <div className="form-check custom-checkbox checkbox-primary check-lg me-3 ">
                        <input
                          type="checkbox"
                          className="form-check-input bs_exam_topper_all"
                          id="checkAll"
                          required=""
                  ...
                  <tr>
                    <td>
                      <div className="form-check custom-checkbox checkbox-primary check-lg me-3 ">
                        <input
                          type="checkbox"
                          className="form-check-input bs_exam_topper"
                          id="customCheckBox2"
                          required=""
                          onClick={() => chackboxFun()}
                        />
              ...
              <Table responsive className="text-nowrap">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <Badge bg="primary light">Sale</Badge>
                    </td>
                    <td>January 22</td>
                    <td className="text-primary text-end">$21.56</td>
                  </tr>
                  <tr>
                    <th>2</th>
                    ...
                    <td>January 30</td>
                    <td className="text-success text-end">$55.32</td>
                  </tr>
                  <tr>
                    <th>3</th>
                    ...
                    <td>January 25</td>
                    <td className="text-danger text-end">$14.85</td>
                  </tr>
                </tbody>
              </Table>
            </Card.Body>
        ...
        <Col lg={12}>
          <Card>
            ...
            <Card.Body>
              <Table responsive className="text-nowrap" striped>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Name</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>January 22</td>
                    <td className="color-primary text-end">$21.56</td>
                  </tr>
                  <tr>
                    <th>2</th>
                    ...
                    <td>January 30</td>
                    <td className="color-success text-end">$55.32</td>
                  </tr>
                  <tr>
                    <th>3</th>
                    <td>Blue Backpack For Baby</td>
                    ...
                    <td>January 25</td>
                    <td className="color-danger text-end">$14.85</td>
                  </tr>
                </tbody>
              </Table>
            </Card.Body>
        ...
        <Col lg={12}>
          <Card>
            ...
            <Card.Body>
              <Table responsive className="text-nowrap" bordered>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Name</th>
        ...
        <Col lg={12}>
          <Card>
            ...
            <Card.Body>
              <Table responsive className="text-nowrap" hover>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Name</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Blue Backpack For Baby</td>
                    <td>
                      <Badge bg="danger light">Extended</Badge>
                    </td>
                    <td>January 25</td>
                    <td className="color-danger text-end">$14.85</td>
                  </tr>
        ...
        <Col lg={12}>
          <Card>
            ...
            <Card.Body>
              <Table responsive className="header-border text-nowrap">
                <thead>
                  <tr>
                    <th>Invoice</th>
                    <th>User</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>$245.30</td>
                    <td>
                      <Badge bg="info light">Shipped</Badge>
                    </td>
                    <td className="text-end">CN</td>
                  </tr>
                  <tr>
                    <td>
