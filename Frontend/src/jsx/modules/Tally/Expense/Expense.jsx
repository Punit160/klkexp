...
const Expense = () => {
  ...
  return (
    <>
      ...
      <Col lg={12}>
        <Card>
          <Card.Header className="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <Card.Title className="mb-0 flex-shrink-0">Expense Voucher List</Card.Title>
            ...
            <div className="d-flex align-items-center gap-2 flex-wrap flex-lg-nowrap ms-auto">
              ...
              >
                <i className="fa fa-plus me-1"></i> New Expense
              </button>
            </div>
          </Card.Header>
      ...
      {/* Big modal popup for Add / Edit Expense Voucher */}
      <Modal
        show={showFormModal}
