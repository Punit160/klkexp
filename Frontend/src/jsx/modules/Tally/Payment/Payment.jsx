...
const staticData = [
  ...
  },
  {
    ...
    Narration: "paid to vendor advance",
    Amount: 22000,
    status: "Draft",
  },
  {
    ...
    Narration: "paid to staff imprest",
    Amount: 6500,
    status: "Posted",
  },
  {
    ...
    Narration: "cancelled payment entry",
    Amount: 4000,
    status: "Cancelled",
  },
];
...
const Payment = () => {
  ...
  const handleDelete = (id) => {
    ...
    alert(`(Static demo) Payment voucher ${id} would be deleted here.`);
  };
  ...
  const filteredData = paginatedData.filter((p) => {
    ...
    const matchesDate = dateFilter ? p.VoucherDate === dateFilter : true;
    return matchesStatus && matchesDate;
  });

  return (
    <>
      <PageTitle activeMenu="Payment Voucher Management" motherMenu="Tally" />
              ...
              <Card className="border-0 shadow-sm rounded">
                <Card.Body>
                  <Card.Header className="d-flex align-items-center justify-content-between flex-wrap gap-3 bg-white">
                    <Card.Title className="mb-0 flex-shrink-0 fw-bold">Payment Voucher List</Card.Title>
                    ...
                    <div className="d-flex align-items-center gap-2 flex-wrap flex-lg-nowrap ms-auto">
                      ...
                      <button
                        ...
                        onClick={openAddForm}
                      >
                        <i className="fa fa-plus"></i> New Payment
                      </button>
                    </div>
                  </Card.Header>
                </Card.Body>
            ...
            <Col lg={12}>
              <Card className="border-0 shadow-sm">
                <Card.Body className="pt-0">
                  <Table responsive className="pv-table text-nowrap align-middle mb-0">
                    <thead>
                      <tr>
                        <th>Sno</th>
                        <th>Voucher No</th>
                          ...
                          <tr key={note.id || index}>
                            ...
                            <td>
                              <Badge
                                ...
                                className="pv-status-badge rounded-pill"
                              >
      ...
      {view === "form" && (
        <Row>
          ...
          <Col lg={8}>
            <Card className="border-0 shadow-sm">
              <Card.Header className="d-flex align-items-center gap-2 bg-white">
                <button className="btn btn-light pv-action-btn" onClick={closeForm} title="Back to list">
                  <i className="fa fa-arrow-left"></i>
                </button>
                <Card.Title className="mb-0 fw-bold">
                  {editId ? "Edit Payment Voucher" : "New Payment Voucher"}
                </Card.Title>
              </Card.Header>
              <Card.Body>
                <PaymentForm
          ...
          {/* Live preview — col-4 */}
          <Col lg={4}>
            <div className="pv-sticky-panel">
              <PaymentPreview data={liveData} isEdit={!!editId} />
            </div>
          </Col>
        </Row>
      )}
      ...
      <style>{`
    .pv-sticky-panel { position: sticky; top: 85px; }
        @media (max-width: 991px) { .pv-sticky-panel { position: static; margin-top: 1.5rem; } }
      `}
      </style>
    </>
  );
