...
const DeliveryChallan = () => {
  ...
  return (
    <>
      ...
      <Col lg={12}>
        <Card>
          <Card.Header className="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <Card.Title className="mb-0 flex-shrink-0">Delivery Challan List</Card.Title>
            ...
            <div className="d-flex align-items-center gap-2 flex-wrap flex-lg-nowrap ms-auto">
              ...
              >
                <i className="fa fa-plus me-1"></i> New Delivery Challan
              </button>
            </div>
          </Card.Header>
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((note, index) => (
                    <tr key={note.id || index}>
                      ...
                      <td>{note.Challanamount != null ? note.Challanamount : "N/A"}</td>
      ...
      {/* Big modal popup for Add / Edit Delivery Challan */}
      <Modal
        show={showFormModal}
