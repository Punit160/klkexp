...
<Row>
  ...
  <Col xl={3} lg={6} md={6} sm={6}>
    <Card>
      ...
      <Col lg={12}>
        <Card>
          <Card.Header className="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <Card.Title className="mb-0 flex-shrink-0">Credit Note List</Card.Title>
            ...
            <div className="d-flex align-items-center gap-2 flex-wrap flex-lg-nowrap ms-auto">
              ...
              >
                <i className="fa fa-plus me-1"></i> New Credit Note
              </button>
            </div>
          </Card.Header>
      ...
      {/* Big modal popup for Add / Edit Credit Note */}
      <Modal
        show={showFormModal}
