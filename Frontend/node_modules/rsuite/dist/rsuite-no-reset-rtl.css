...
.rs-tree-indent-line {
  ...
  border-right: 1px solid var(--rs-tree-indent-line-color);
  position: absolute;
  width: 1px;
  top: -10px;
  right: 12px;
...
.rs-toggle-presentation::after {
  ...
  -webkit-transition: right 0.15s ease-out, margin-right 0.15s ease-out, width 0.15s ease-out;
  transition: right 0.15s ease-out, margin-right 0.15s ease-out, width 0.15s ease-out;
}
...
.rs-tree-node-label::after {
  ...
  height: 0;
  right: -8px;
  border-right: 6px solid #1675e0;
  border-right: 6px solid var(--rs-text-link);
...
blockquote.rs-text {
  ...
  border-right: 2px solid var(--rs-gray-200);
}
kbd.rs-text {
  background-color: #f7f7fa;
  background-color: var(--rs-bg-well);
