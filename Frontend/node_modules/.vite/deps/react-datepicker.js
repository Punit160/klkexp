...
function parseISO(argument, options) {
  ...
  return toDate(timestamp + time + offset3, options == null ? void 0 : options.in);
}
var patterns = {
  dateTimeDelimiter: /[T ]/,
...
var CalendarContainer = function(_a2) {
  var _b = _a2.showTimeSelectOnly, showTimeSelectOnly = _b === void 0 ? false : _b, _c = _a2.showTime, showTime = _c === void 0 ? false : _c, className = _a2.className, children = _a2.children, inline3 = _a2.inline;
  var ariaLabel = showTimeSelectOnly ? "Choose Time" : "Choose Date".concat(showTime ? " and Time" : "");
  return import_react3.default.createElement("div", { className, "aria-label": ariaLabel, role: inline3 ? void 0 : "dialog", "aria-modal": inline3 ? void 0 : "true" }, children);
};
    ...
    function Calendar2(props) {
      ...
      _this.header = function(date) {
        ...
        return dayNames.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset3) {
          ...
          return import_react3.default.createElement(
            "div",
            { key: offset3, role: "columnheader", className: clsx("react-datepicker__day-name", weekDayClassName, disabled ? "react-datepicker__day-name--disabled" : "") },
            import_react3.default.createElement("span", { className: "react-datepicker__sr-only" }, formatDate(day, "EEEE", _this.props.locale)),
      ...
      _this.renderDayNamesHeader = function(monthDate) {
        return import_react3.default.createElement("div", { className: "react-datepicker__day-names", role: "row" }, _this.header(monthDate));
      };
...
var DatePicker = (
  ...
  (function(_super) {
    ...
    DatePicker2.prototype.render = function() {
      ...
      return import_react3.default.createElement(PopperComponent, _assign({}, this.props, { className: this.props.popperClassName, hidePopper: !this.isCalendarOpen(), targetComponent: this.renderInputContainer(), popperComponent: calendar, popperOnKeyDown: this.onPopperKeyDown, showArrow: this.props.showPopperArrow }));
    };
    return DatePicker2;
  })(import_react3.Component)
);
