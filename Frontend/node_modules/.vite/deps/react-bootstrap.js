...
import {
  ...
  map,
  useCol
} from "./chunk-44MNN7IF.js";
import "./chunk-CGNDA4IS.js";
import {
  ButtonGroup_default,
  SplitButton_default
} from "./chunk-DFYEH66I.js";
import {
  ...
  useWindow
} from "./chunk-W2WAHLG4.js";
import "./chunk-SDQN7NLV.js";
import {
  _inheritsLoose
} from "./chunk-33JGGRSO.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-FC2POG6I.js";
import {
  require_warning
} from "./chunk-X4BAV6GF.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-XGM2UL2M.js";
import {
  require_prop_types
} from "./chunk-Z3EYR25T.js";
import {
  require_react_dom
} from "./chunk-MBF6TY2F.js";
import {
  require_jsx_runtime
} from "./chunk-EZIAUW43.js";
import "./chunk-EBVFFPOK.js";
import {
  require_react
} from "./chunk-EZWJ4YC2.js";
import {
  __toESM
...
var divWithClassName_default = ((className) => (
  ...
  React14.forwardRef((p, ref) => (0, import_jsx_runtime9.jsx)("div", {
    ...p,
    ref,
...
var CardHeader = React27.forwardRef(({
  ...
  return (0, import_jsx_runtime22.jsx)(CardHeaderContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime22.jsx)(Component2, {
      ref,
      ...props,
...
var Card = React34.forwardRef(({
  ...
  return (0, import_jsx_runtime29.jsx)(Component2, {
    ...
    children: body ? (0, import_jsx_runtime29.jsx)(CardBody_default, {
      children
    }) : children
  });
});
...
function useMounted2() {
  ...
  const isMounted = (0, import_react13.useRef)(() => mounted.current);
...
function useWillUnmount(fn) {
  ...
  (0, import_react15.useEffect)(() => () => onUnmount.current(), []);
}
...
function useTimeout() {
  ...
  const handleRef = (0, import_react16.useRef)();
...
var Carousel = (
  ...
  React38.forwardRef(({
    ...
    const {
      ...
      onTouchMove,
      onTouchEnd,
      prevIcon = (0, import_jsx_runtime33.jsx)("span", {
        "aria-hidden": "true",
        className: "carousel-control-prev-icon"
      }),
      prevLabel = "Previous",
      nextIcon = (0, import_jsx_runtime33.jsx)("span", {
        "aria-hidden": "true",
    ...
    const nextDirectionRef = (0, import_react17.useRef)(null);
    const [direction, setDirection] = (0, import_react17.useState)("next");
    const [paused, setPaused] = (0, import_react17.useState)(false);
    const [isSliding, setIsSliding] = (0, import_react17.useState)(false);
    const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react17.useState)(activeIndex || 0);
    ...
    const prev = (0, import_react17.useCallback)((event) => {
      if (isSliding) {
        return;
      }
    ...
    const elementRef = (0, import_react17.useRef)();
    ...
    const handleEnter = (0, import_react17.useCallback)((node) => {
      triggerBrowserReflow(node);
      onSlide == null || onSlide(renderedActiveIndex, slideDirection);
    }, [onSlide, renderedActiveIndex, slideDirection]);
    const handleEntered = (0, import_react17.useCallback)(() => {
      setIsSliding(false);
      onSlid == null || onSlid(renderedActiveIndex, slideDirection);
    ...
    const handleMouseOver = (0, import_react17.useCallback)((event) => {
      if (pause === "hover") {
        setPaused(true);
      }
      onMouseOver == null || onMouseOver(event);
    }, [pause, onMouseOver]);
    const handleMouseOut = (0, import_react17.useCallback)((event) => {
      setPaused(false);
      onMouseOut == null || onMouseOut(event);
    }, [onMouseOut]);
    const touchStartXRef = (0, import_react17.useRef)(0);
    const touchDeltaXRef = (0, import_react17.useRef)(0);
    const touchUnpauseTimeout = useTimeout();
    const handleTouchStart = (0, import_react17.useCallback)((event) => {
    ...
    const handleTouchMove = (0, import_react17.useCallback)((event) => {
    ...
    const handleTouchEnd = (0, import_react17.useCallback)((event) => {
      if (touch) {
    ...
    const intervalHandleRef = (0, import_react17.useRef)();
    (0, import_react17.useEffect)(() => {
    ...
    const indicatorOnClicks = (0, import_react17.useMemo)(() => indicators && Array.from({
      length: numChildren
    }, (_, index) => (event) => {
      onSelect == null || onSelect(index, event);
    }), [indicators, numChildren, onSelect]);
    return (0, import_jsx_runtime34.jsxs)(Component2, {
      ref: elementRef,
      ...props,
      ...
      children: [indicators && (0, import_jsx_runtime33.jsx)("div", {
        className: `${prefix}-indicators`,
        children: map(children, (_, index) => (0, import_jsx_runtime33.jsx)("button", {
          type: "button",
          "data-bs-target": "",
        ...
        children: map(children, (child, index) => {
          ...
          return slide ? (0, import_jsx_runtime33.jsx)(TransitionWrapper_default, {
            in: isActive,
      ...
      }), controls && (0, import_jsx_runtime34.jsxs)(import_jsx_runtime35.Fragment, {
        children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime34.jsxs)(Anchor_default, {
          className: `${prefix}-control-prev`,
          onClick: prev,
          children: [prevIcon, prevLabel && (0, import_jsx_runtime33.jsx)("span", {
            className: "visually-hidden",
            children: prevLabel
          })]
        }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime34.jsxs)(Anchor_default, {
          className: `${prefix}-control-next`,
          onClick: next,
          children: [nextIcon, nextLabel && (0, import_jsx_runtime33.jsx)("span", {
            className: "visually-hidden",
            children: nextLabel
          })]
        })]
...
var DropdownButton = React40.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime38.jsxs)(Dropdown_default, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime37.jsx)(DropdownToggle_default, {
    id,
    href,
    size: size2,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime37.jsx)(DropdownMenu_default, {
    role: menuRole,
...
var Image = React41.forwardRef(({
  ...
  return (0, import_jsx_runtime39.jsx)("img", {
    ref,
    ...props,
...
var FigureImage = React42.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime40.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var TabContext = React45.createContext(null);
...
var NavItem = React46.forwardRef((_ref, ref) => {
  let {
  ...
  return (0, import_jsx_runtime43.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React47.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  const needsRefocusRef = (0, import_react20.useRef)(false);
  const parentOnSelect = (0, import_react20.useContext)(SelectableContext_default);
  const tabContext = (0, import_react20.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react20.useRef)(null);
  ...
  return (0, import_jsx_runtime44.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime44.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime44.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
var ListGroupItem = React48.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React49.forwardRef((props, ref) => {
  const {
    className,
  ...
  return (0, import_jsx_runtime46.jsx)(Nav_default, {
    ref,
    ...controlledProps,
    as,
...
function useCallbackRef2() {
  return (0, import_react21.useState)(null);
}
...
function useUpdatedRef2(value) {
  const valueRef = (0, import_react22.useRef)(value);
  valueRef.current = value;
  return valueRef;
}
...
function useWillUnmount2(fn) {
  ...
  (0, import_react23.useEffect)(() => () => onUnmount.current(), []);
}
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react24.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react25.useRef)(inProp);
  ...
  const child = (0, import_react25.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react26.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react26.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react26.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react26.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react26.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react26.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react26.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react26.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React50.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose5(_ref, _excluded4);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime47.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function useTransition({
  ...
  const isInitialRef = (0, import_react27.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react27.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react27.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime48.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime48.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime48.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react28.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react28.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react28.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react28.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react28.useState)(!show);
  const lastFocusRef = (0, import_react28.useRef)(null);
  (0, import_react28.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react28.useRef)();
  const removeKeydownListenerRef = (0, import_react28.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime49.jsx)("div", Object.assign({}, dialogProps, {
    children: React52.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime49.jsx)(import_jsx_runtime49.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, {
...
var ModalBody = React53.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React54.createContext({
  onHide() {
  }
});
...
var AbstractModalHeader = React57.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context4 = (0, import_react29.useContext)(ModalContext_default);
...
var ModalHeader = React58.forwardRef(({
  ...
  return (0, import_jsx_runtime55.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var Modal2 = React60.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react30.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react30.useState)(false);
  const waitingForMouseUpRef = (0, import_react30.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react30.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react30.useRef)(null);
  ...
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react30.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react30.useCallback)((backdropProps) => (0, import_jsx_runtime57.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime57.jsx)("div", {
    ...
    className: (0, import_classnames44.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
...
var NavItem2 = React61.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React62.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime59.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames46.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React63.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react31.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react31.useContext)(CardHeaderContext_default);
  if (navbarContext) {
  ...
  return (0, import_jsx_runtime60.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
    className: (0, import_classnames47.default)(className, {
      [bsPrefix]: !isNavbar,
...
var NavbarBrand = React64.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React65.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context4 = (0, import_react32.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime62.jsx)(Collapse_default, {
...
var NavbarToggle = React66.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react33.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime63.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime63.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react34.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react35.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React67.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React68.forwardRef(({
  ...
  return (0, import_jsx_runtime65.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
var OffcanvasHeader = React69.forwardRef(({
  ...
  return (0, import_jsx_runtime66.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var OffcanvasTitle = React70.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime68.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React71.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const modalManager = (0, import_react36.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react36.useState)(false);
  const handleHide = useEventCallback2(onHide);
  const hideResponsiveOffcanvas = useBreakpoint_default(responsive || "xs", "up");
  (0, import_react36.useEffect)(() => {
    setShowOffcanvas(responsive ? show && !hideResponsiveOffcanvas : show);
  }, [show, responsive, hideResponsiveOffcanvas]);
  const modalContext = (0, import_react36.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  function getModalManager() {
    if (propsManager) return propsManager;
  ...
  const renderBackdrop = (0, import_react36.useCallback)((backdropProps) => (0, import_jsx_runtime68.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime70.jsxs)(import_jsx_runtime69.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime68.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React72.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context4 = (0, import_react37.useContext)(NavbarContext_default);
  const handleHide = useEventCallback2(() => {
    context4 == null || context4.onToggle == null || context4.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime71.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React73.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React74.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  const handleCollapse = (0, import_react38.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react38.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime73.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React75.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime75.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames57.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime74.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime74.jsx)(Dropdown_default.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React76.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
  ...
  const [exited, setExited] = (0, import_react40.useState)(!props.show);
...
var PopoverHeader = React77.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React78.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React80.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime79.jsxs)("div", {
    ...
    className: (0, import_classnames60.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime78.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime78.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React81.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime81.jsxs)("div", {
    ref,
    style: computedStyle,
    role: "tooltip",
    "x-placement": primaryPlacement,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react41.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React82.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react42.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react42.useState)(null);
  ...
  return (0, import_jsx_runtime82.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React82.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames62.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React83.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react43.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react43.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react43.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react43.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react43.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react43.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react43.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime85.jsxs)(import_jsx_runtime84.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react43.cloneElement)(children, triggerProps), (0, import_jsx_runtime83.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React84.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
  ...
  return (0, import_jsx_runtime86.jsx)("li", {
    ref,
    style: style2,
    className: (0, import_classnames63.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime87.jsxs)(Component2, {
      className: (0, import_classnames63.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime86.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React84.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime87.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React85.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime88.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames64.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames65.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React86.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime89.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React87.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime91.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames66.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime91.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React88.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsx)("div", {
    ...
    className: (0, import_classnames67.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React90.forwardRef(({
  ...
  return (0, import_jsx_runtime93.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames68.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React91.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
  ...
  return (0, import_jsx_runtime94.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames69.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var Stack = React92.forwardRef(({
  ...
  return (0, import_jsx_runtime95.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames70.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react45.useContext)(TabContext_default);
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime96.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime96.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime96.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime96.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime98.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React95.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React96.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime100.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime100.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime100.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime100.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames72.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React97.forwardRef(({
  ...
  const classes = (0, import_classnames73.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime101.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime102.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime102.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime103.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime102.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime102.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime102.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React99.forwardRef((props, ref) => (0, import_jsx_runtime104.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React100.createContext({
  onClose() {
  }
});
...
var ToastHeader = React101.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context4 = (0, import_react47.useContext)(ToastContext_default);
  const handleClick = useEventCallback2((e) => {
    context4 == null || context4.onClose == null || context4.onClose(e);
  });
  return (0, import_jsx_runtime106.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames74.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime105.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React102.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React103.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime108.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames76.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime108.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime108.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React104.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime109.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames77.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop4 = () => void 0;
var ToggleButton = React105.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime112.jsxs)(import_jsx_runtime111.Fragment, {
    children: [(0, import_jsx_runtime110.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime110.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames78.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React106.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime113.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
