...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  } = _ref, config = _objectWithoutPropertiesLoose2(_ref, _excluded);
...
function useDropdownMenu(options = {}) {
  const context2 = (0, import_react12.useContext)(DropdownContext_default);
...
var $c7eafbbe1ea5834e$var$SSRContext = (0, import_react13.default).createContext($c7eafbbe1ea5834e$var$defaultContext);
var $c7eafbbe1ea5834e$var$IsSSRContext = (0, import_react13.default).createContext(false);
function $c7eafbbe1ea5834e$var$LegacySSRProvider(props) {
  let cur = (0, import_react13.useContext)($c7eafbbe1ea5834e$var$SSRContext);
  ...
  return (0, import_react13.default).createElement($c7eafbbe1ea5834e$var$SSRContext.Provider, {
    value
  }, (0, import_react13.default).createElement($c7eafbbe1ea5834e$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
...
function $c7eafbbe1ea5834e$export$9f8ac96af4b1b2ae(props) {
  ...
  return (0, import_react13.default).createElement($c7eafbbe1ea5834e$var$LegacySSRProvider, props);
}
...
function $c7eafbbe1ea5834e$var$useCounter(isDisabled = false) {
  var _a, _b;
  let ctx = (0, import_react13.useContext)($c7eafbbe1ea5834e$var$SSRContext);
  let ref = (0, import_react13.useRef)(null);
  if (ref.current === null && !isDisabled) {
    let currentOwner = (_b = (_a = (0, import_react13.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) == null ? void 0 : _a.ReactCurrentOwner) == null ? void 0 : _b.current;
    if (currentOwner) {
...
function $c7eafbbe1ea5834e$var$useModernSSRSafeId(defaultId) {
  ...
  let [didSSR] = (0, import_react13.useState)($c7eafbbe1ea5834e$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$c7eafbbe1ea5834e$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $c7eafbbe1ea5834e$export$619500959fc48b26 = typeof (0, import_react13.default)["useId"] === "function" ? $c7eafbbe1ea5834e$var$useModernSSRSafeId : $c7eafbbe1ea5834e$var$useLegacySSRSafeId;
...
function $c7eafbbe1ea5834e$export$535bd6ca7f90a273() {
  if (typeof (0, import_react13.default)["useSyncExternalStore"] === "function") return (0, import_react13.default)["useSyncExternalStore"]($c7eafbbe1ea5834e$var$subscribe, $c7eafbbe1ea5834e$var$getSnapshot, $c7eafbbe1ea5834e$var$getServerSnapshot);
  return (0, import_react13.useContext)($c7eafbbe1ea5834e$var$IsSSRContext);
}
...
function Dropdown({
  ...
  const context2 = (0, import_react17.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  return (0, import_jsx_runtime5.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime5.jsx)(DropdownContext_default.Provider, {
      value: context2,
      children
    })
  });
...
function useEventCallback2(fn2) {
  ...
  return (0, import_react21.useCallback)(function(...args) {
    return ref.current && ref.current(...args);
  }, [ref]);
}
...
var DropdownDivider = React11.forwardRef(({
  className,
  bsPrefix,
  as: Component = "hr",
  role = "separator",
...
var DropdownHeader = React12.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  role = "heading",
...
var Anchor = React13.forwardRef((_ref, ref) => {
  let {
    onKeyDown
  ...
  if (isTrivialHref2(props.href) || props.role === "button") {
    return (0, import_jsx_runtime8.jsx)("a", Object.assign({
      ref
    }, props, buttonProps, {
      onKeyDown: handleKeyDown
    }));
...
var DropdownItem2 = React14.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var DropdownItemText = React15.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react29.useLayoutEffect : import_react29.useEffect;
...
function useMergedRefs(refA, refB) {
  return (0, import_react30.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var context = React16.createContext(null);
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false) return ref;
  const warningRef = (0, import_react31.useCallback)((refValue) => {
...
var DropdownMenu2 = React17.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react32.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react32.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React19.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  const dropdownContext = (0, import_react33.useContext)(DropdownContext_default);
...
var Dropdown2 = React20.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  return (0, import_jsx_runtime14.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime14.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime14.jsx)(Component, {
        ...props,
        ref,
...
export {
  require_browser,
  useUncontrolledProp2 as useUncontrolledProp,
  useUncontrolled,
  ownerDocument,
  canUseDOM_default,
  ...
  useCommittedRef_default2 as useCommittedRef_default,
...
//# sourceMappingURL=chunk-QWOVI6WN.js.map
