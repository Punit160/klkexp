...
import { t as warning } from "./tiny-warning.esm-aLQSC7oe.js";
import { t as require_hoist_non_react_statics_cjs } from "./hoist-non-react-statics.cjs-v2cudgNP.js";
import { t as require_prop_types } from "./prop-types.js";
import { n as _objectWithoutPropertiesLoose$1, r as _extends$2 } from "./setPrototypeOf-SwOIxZ9t.js";
import { t as _inheritsLoose$1 } from "./inheritsLoose-Cp3aajTV.js";
import { n as _assertThisInitialized$1, r as _createClass, t as _toConsumableArray } from "./toConsumableArray-D8Ias4A7.js";
//#region node_modules/react-form-stepper/node_modules/clsx/dist/clsx.m.js
...
//#endregion
//#region node_modules/react-display-name/lib/getDisplayName.js
...
//#endregion
//#region node_modules/theming/dist/theming.esm.js
var import_prop_types = /* @__PURE__ */ __toESM(require_prop_types());
var import_hoist_non_react_statics_cjs = /* @__PURE__ */ __toESM(require_hoist_non_react_statics_cjs());
var import_getDisplayName = /* @__PURE__ */ __toESM(require_getDisplayName());
	...
	var ThemeProvider = /* @__PURE__ */ function(_React$Component) {
		...
		function ThemeProvider() {
			...
			_defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderProvider", function(outerTheme) {
				...
				return import_react.createElement(context.Provider, { value: _this.getTheme(outerTheme) }, children);
			});
			return _this;
		}
		...
		_proto.getTheme = function getTheme(outerTheme) {
			if (this.props.theme !== this.lastTheme || outerTheme !== this.lastOuterTheme || !this.cachedTheme) {
				...
				if (typeof this.lastTheme === "function") {
					...
					warning(isObject$1(this.cachedTheme), "[ThemeProvider] Please return an object from your theme function");
				} else {
					var _theme = this.props.theme;
					warning(isObject$1(_theme), "[ThemeProvider] Please make your theme prop a plain object");
		...
		_proto.render = function render() {
			...
			return import_react.createElement(context.Consumer, null, this.renderProvider);
		};
...
function createWithTheme(context) {
	return function hoc(Component) {
		var withTheme = import_react.forwardRef(function(props, ref) {
			return import_react.createElement(context.Consumer, null, function(theme) {
				warning(isObject$1(theme), "[theming] Please use withTheme only with the ThemeProvider");
				return import_react.createElement(Component, _extends$1({
					theme,
					ref
				}, props));
			});
		});
		withTheme.displayName = "WithTheme(" + (0, import_getDisplayName.default)(Component) + ")";
...
function createUseTheme(context) {
	return function useTheme() {
		var theme = import_react.useContext(context);
		warning(isObject$1(theme), "[theming] Please use useTheme only with the ThemeProvider");
		return theme;
	};
}
...
var ThemeContext = (0, import_react.createContext)(), _createTheming = createTheming(ThemeContext);
_createTheming.withTheme;
_createTheming.ThemeProvider;
_createTheming.useTheme;
//#endregion
//#region node_modules/is-in-browser/dist/module.js
...
function createRule(name, decl, options) {
	...
	if (rule) return rule;
	if (name[0] === "@") warning(false, "[JSS] Unknown rule " + name);
	return null;
}
...
function toCss(selector, style, options) {
	...
	if (selector) indent++;
	if (fallbacks) if (Array.isArray(fallbacks)) for (var index = 0; index < fallbacks.length; index++) {
...
var BaseStyleRule = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.prop = function prop(name, value, options) {
		...
		if (sheet && sheet.attached) warning(false, "[JSS] Rule is not linked. Missing sheet option \"link: true\".");
		return this;
	};
...
var StyleRule = /* @__PURE__ */ function(_BaseStyleRule) {
	...
	*/
	...
	_proto2.toString = function toString(options) {
		var sheet = this.options.sheet;
		var opts = (sheet ? sheet.options.link : false) ? _extends$2({}, options, { allowEmpty: true }) : options;
...
var ConditionalRule = /* @__PURE__ */ function() {
	function ConditionalRule(key, styles, options) {
		...
		this.options = options;
		this.rules = new RuleList(_extends$2({}, options, { parent: this }));
...
var KeyframesRule = /* @__PURE__ */ function() {
	function KeyframesRule(key, frames, options) {
		...
		this.rules = new RuleList(_extends$2({}, options, { parent: this }));
		for (var name in frames) this.rules.add(name, frames[name], _extends$2({}, options, { parent: this }));
		this.rules.process();
	}
	/**
...
var RuleList = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.replace = function replace(name, decl, ruleOptions) {
		...
		if (oldIndex !== -1) options = _extends$2({}, ruleOptions, { index: oldIndex });
	...
	*/
	...
	_proto.use = function use(newPlugin, options) {
		...
		this.registry = [].concat(this.plugins.external, this.plugins.internal).reduce(function(registry, plugin) {
			...
			else warning(false, "[JSS] Unknown hook \"" + name + "\".");
			return registry;
		}, {
			onCreateRule: [],
			onProcessRule: [],
...
*/
var sheets = new (/* @__PURE__ */ function() {
...
var createGenerateId = function createGenerateId(options) {
	...
	return function generateId(rule, sheet) {
		ruleCounter += 1;
		if (ruleCounter > maxRules) warning(false, "[JSS] You might have a memory leak. Rule counter is at " + ruleCounter + ".");
		var jssId = "";
		var prefix = "";
		if (sheet) {
...
var DomRenderer = /* @__PURE__ */ function() {
	function DomRenderer(sheet) {
		...
		this.sheet = sheet;
		var _ref = this.sheet ? this.sheet.options : {}, media = _ref.media, meta = _ref.meta;
		this.element = _ref.element || createStyle();
...
var Jss = /* @__PURE__ */ function() {
	...
	*/
	...
	_proto.setup = function setup(options) {
		...
		if (options.id) this.options.id = _extends$2({}, this.options.id, options.id);
...
var SheetsManager = /* @__PURE__ */ function() {
	...
	_proto.unmanage = function unmanage(key) {
		...
		} else warning(false, "SheetsManager: can't find sheet to unmanage");
	};
...
createJss();
//#endregion
//#region node_modules/jss-plugin-rule-value-function/dist/jss-plugin-rule-value-function.esm.js
var now = Date.now();
...
//#endregion
//#region node_modules/symbol-observable/es/ponyfill.js
function symbolObservablePonyfill(root) {
	var result;
	var Symbol = root.Symbol;
	if (typeof Symbol === "function") if (Symbol.observable) result = Symbol.observable;
	else {
...
//#endregion
//#region node_modules/symbol-observable/es/index.js
var root;
...
//#endregion
//#region node_modules/jss-plugin-rule-value-observable/dist/jss-plugin-rule-value-observable.esm.js
...
//#endregion
//#region node_modules/jss-plugin-template/dist/jss-plugin-template.esm.js
var semiWithNl = /;\n/;
/**
* Naive CSS parser.
...
var GlobalPrefixedRule = /* @__PURE__ */ function() {
	function GlobalPrefixedRule(key, style, options) {
		...
		this.rule = options.jss.createRule(selector, style, _extends$2({}, options, { parent: this }));
	}
...
function handleNestedGlobalContainerRule(rule, sheet) {
	...
	if (!rules) return;
	for (var name in rules) sheet.addRule(name, rules[name], _extends$2({}, options, { selector: addScope(name, rule.selector) }));
	delete style[at];
}
function handlePrefixedGlobalRule(rule, sheet) {
	...
	for (var prop in style) {
		...
		sheet.addRule(selector, style[prop], _extends$2({}, options, { selector }));
		delete style[prop];
	}
}
/**
...
//#endregion
//#region node_modules/jss-plugin-extend/dist/jss-plugin-extend.esm.js
...
function mergeExtend(style, rule, sheet, newStyle) {
	...
	if (Array.isArray(style.extend)) {
		for (var index = 0; index < style.extend.length; index++) {
			...
			extend(typeof singleExtend === "string" ? _extends$2({}, style, { extend: singleExtend }) : style.extend[index], rule, sheet, newStyle);
		}
		return;
	}
...
function jssNested() {
	...
	function getOptions(rule, container, prevOptions) {
		if (prevOptions) return _extends$2({}, prevOptions, { index: prevOptions.index + 1 });
	...
	function onProcessStyle(style, rule, sheet) {
		...
		for (var prop in style) {
			...
			if (isNested) {
				...
				if ("replaceRule" in container) container.replaceRule(name, style[prop], _extends$2({}, options, { selector }));
				else container.addRule(name, style[prop], _extends$2({}, options, { selector }));
...
//#endregion
//#region node_modules/jss-plugin-compose/dist/jss-plugin-compose.esm.js
/**
* Set selector.
*
* @param original rule
...
function convertCase(style) {
	...
	if (style.fallbacks) if (Array.isArray(style.fallbacks)) converted.fallbacks = style.fallbacks.map(convertCase);
...
function iterate(prop, value, options) {
	...
	else if (typeof value === "object") if (prop === "fallbacks") for (var innerProp in value) value[innerProp] = iterate(innerProp, value[innerProp], options);
...
//#endregion
//#region node_modules/jss-plugin-expand/dist/jss-plugin-expand.esm.js
/**
...
//#endregion
//#region node_modules/jss-preset-default/dist/jss-preset-default.esm.js
...
memoize(function(prop) {
	return reactPropsRegex.test(prop) || prop.charCodeAt(0) === 111 && prop.charCodeAt(1) === 110 && prop.charCodeAt(2) < 91;
});
//#endregion
//#region node_modules/css-jss/dist/css-jss.esm.js
var MAX_RULES_PER_SHEET = 1e4;
var defaultJss$1 = createJss(create$1());
var css = function createCss(jss) {
	if (jss === void 0) jss = defaultJss$1;
...
//#endregion
//#region node_modules/react-jss/dist/react-jss.esm.js
/**
...
var JssContext = (0, import_react.createContext)({
	classNamePrefix: "",
...
var getManager = function getManager(context, managerId) {
	...
	if (managers) {
		if (!managers[managerId]) managers[managerId] = new SheetsManager();
...
var defaultJss = createJss(create$1());
...
function getSheetOptions(options, link) {
	...
	return _extends$2({}, options.sheetOptions, {
		index: options.index,
		meta,
		classNamePrefix,
		link,
...
function getUseInsertionEffect(isSSR) {
	return isSSR ? import_react.useEffect : import_react.useInsertionEffect || import_react.useLayoutEffect;
}
var noTheme = {};
var createUseStyles = function createUseStyles(styles, options) {
	if (options === void 0) options = {};
	var _options = options, _options$index = _options.index, index = _options$index === void 0 ? getSheetIndex() : _options$index, theming = _options.theming, name = _options.name, sheetOptions = _objectWithoutPropertiesLoose$1(_options, [
		"index",
		"theming",
		"name"
	]);
	...
	var useTheme = function useTheme(theme) {
		if (typeof styles === "function") return theme || (0, import_react.useContext)(ThemeContext$1) || noTheme;
		return noTheme;
	};
	var emptyObject = {};
	return function useStyles(data) {
		var isFirstMount = (0, import_react.useRef)(true);
		var context = (0, import_react.useContext)(JssContext);
		...
		(0, import_react.useDebugValue)(classes);
		(0, import_react.useDebugValue)(theme === noTheme ? "No theme" : theme);
...
(function create(css$2) {
	if (css$2 === void 0) css$2 = css;
	return function createElement$1(type, props) {
		var args = arguments;
		if (props && props.css) {
			var className = css$2(props.css);
...
//#endregion
//#region node_modules/simple-swizzle/node_modules/is-arrayish/index.js
var require_is_arrayish = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_simple_swizzle = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_color_string = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/color/node_modules/color-name/index.js
...
//#endregion
//#region node_modules/color/node_modules/color-convert/conversions.js
var require_conversions = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* */
	...
	convert.rgb.hex = function(args) {
		var string = (((Math.round(args[0]) & 255) << 16) + ((Math.round(args[1]) & 255) << 8) + (Math.round(args[2]) & 255)).toString(16).toUpperCase();
...
//#endregion
//#region node_modules/color/node_modules/color-convert/route.js
...
//#endregion
//#region node_modules/color/node_modules/color-convert/index.js
...
//#endregion
//#region node_modules/react-form-stepper/dist/react-form-stepper.esm.js
var import_color = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function Color(obj, model) {
		...
		if (obj == null) {
			...
			channels = convert[this.model].channels;
			this.color = zeroArray(_slice.call(obj, 0, channels), channels);
	...
	Color.prototype = {
		...
		isDark: function() {
			var rgb = this.rgb().color;
			return (rgb[0] * 299 + rgb[1] * 587 + rgb[2] * 114) / 1e3 < 128;
		},
		isLight: function() {
			return !this.isDark();
		},
...
var HOVER_COLOR_DEFAULT_RATIO = .15;
var ACTIVE_COLOR_DEFAULT_RATIO = .2;
...
var useStepStyles = /* @__PURE__ */ createUseStyles({
	...
	StepButton: function StepButton(props) {
		return {
			...
			"&.active": {
				...
				"&:hover": { backgroundColor: shadeOrTintColor(props.activeBgColor, HOVER_COLOR_DEFAULT_RATIO) },
				"&:active": { backgroundColor: shadeOrTintColor(props.activeBgColor, ACTIVE_COLOR_DEFAULT_RATIO) }
			},
			"&.completed": {
				backgroundColor: props.completedBgColor,
				"&:hover": { backgroundColor: shadeOrTintColor(props.completedBgColor, HOVER_COLOR_DEFAULT_RATIO) },
				"&:active": { backgroundColor: shadeOrTintColor(props.completedBgColor, ACTIVE_COLOR_DEFAULT_RATIO) }
			}
		};
	},
	StepButtonContent: function StepButtonContent(props) {
		return {
			...
			"&.completed": { color: props.completedTextColor }
		};
	}
});
...
var useConnectorStyles = /* @__PURE__ */ createUseStyles({
	...
	Connector: function Connector(props) {
		return {
			...
			display: "block",
			"&.completed": { borderColor: props.completedColor },
			"&.active": { borderColor: props.activeColor }
		};
	}
});
var convertNumericToPixel = function convertNumericToPixel(object, property) {
	if (typeof object[property] === "number") object[property] = object[property] + "px";
};
...
var Connector = function Connector() {
	var _React$useContext = import_react.useContext(StepperContext), connectorStateColors = _React$useContext.connectorStateColors, connectorStyleConfig = _React$useContext.connectorStyleConfig;
	var _React$useContext2 = import_react.useContext(StepContext), completed = _React$useContext2.completed, active = _React$useContext2.active, stepSize = _React$useContext2.stepSize;
	var connectorStyle = _extends({}, connectorStyleDefaults, connectorStyleConfig, { stepSize: (connectorStyleConfig === null || connectorStyleConfig === void 0 ? void 0 : connectorStyleConfig.stepSize) || stepSize });
	...
	return import_react.createElement("div", {
		...
		id: "RFS-Connector",
		className: clsx(classes.Connector, { completed: completed && connectorStateColors }, { active: active && connectorStateColors })
	}));
};
var _excluded = ["children", "contentClasses"];
var StepButton = function StepButton(_ref) {
	var children = _ref.children, contentClasses = _ref.contentClasses, rest = _objectWithoutPropertiesLoose(_ref, _excluded);
	var _React$useContext = import_react.useContext(StepContext), completed = _React$useContext.completed, disabled = _React$useContext.disabled, index = _React$useContext.index;
	return import_react.createElement("button", Object.assign({ disabled }, rest), import_react.createElement("span", { className: clsx(contentClasses, { active: !disabled && !completed }, { completed }) }, children || index + 1));
};
...
var Step = function Step(_ref) {
	var children = _ref.children, _ref$label = _ref.label, label = _ref$label === void 0 ? "" : _ref$label, styleConfig = _ref.styleConfig, completedProp = _ref.completed, activeProp = _ref.active, disabledProp = _ref.disabled, className = _ref.className, _ref$index = _ref.index, index = _ref$index === void 0 ? 0 : _ref$index, rest = _objectWithoutPropertiesLoose(_ref, _excluded$1);
	var _React$useContext = (0, import_react.useContext)(StepperContext), activeStep = _React$useContext.activeStep, hideConnectors = _React$useContext.hideConnectors, nonLinear = _React$useContext.nonLinear;
	...
	else if (!nonLinear && activeStep > index && !activeProp && !disabledProp) completed = completedProp !== void 0 ? completedProp : true;
	else if (!nonLinear && activeStep < index && !activeProp && !completedProp) disabled = disabledProp !== void 0 ? disabledProp : true;
	var stepStyleProps = _extends({}, styleConfig, {
		completed: completed && !disabled,
		active: active || !disabled
	});
	var classes = useStepStyles(_extends({}, stepStyleDefaults, stepStyleProps.size && !stepStyleProps.circleFontSize && { circleFontSize: "calc(" + stepStyleProps.size + " / 2)" }, stepStyleProps));
	var contextValue = {
		completed,
		active,
		disabled,
	...
	return (0, import_react.createElement)(StepContext.Provider, { value: contextValue }, index !== 0 && (hideConnectors === "inactive" && (active || completed) || hideConnectors !== true && hideConnectors !== "inactive") && (0, import_react.createElement)(Connector, null), (0, import_react.createElement)("div", {
		id: "RFS-StepMain",
		className: classes.StepMain
	}, (0, import_react.createElement)(StepButton, Object.assign({
		id: "RFS-StepButton",
		className: clsx(classes.StepButton, { active: !disabled && !completed }, { completed }, className),
		contentClasses: classes.StepButtonContent
	}, rest), children || index + 1), label && (0, import_react.createElement)(StepLabel, {
...
var Stepper = function Stepper(_ref) {
	...
	var stepsToRender = (useStepsProp ? steps : import_react.Children.toArray(children)).map(function(step, index) {
		if (!useStepsProp && !import_react.isValidElement(step)) return null;
		var stepProps = {
		...
		}, import_react.isValidElement(step) ? import_react.cloneElement(step, _extends({}, stepProps, step.props)) : import_react.createElement(Step, Object.assign({}, stepProps, typeof step === "object" ? step : {})));
	});
	return import_react.createElement(StepperContext.Provider, { value: contextValue }, import_react.createElement("div", Object.assign({
