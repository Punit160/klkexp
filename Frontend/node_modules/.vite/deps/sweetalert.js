...
//#region node_modules/sweetalert/dist/sweetalert.min.js
var require_sweetalert_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		return function(t) {
			...
			function(t, e, n) {
				...
				e.overlayMarkup = n(26).default, o(n(27)), o(n(28)), o(n(29));
			...
			function(t, e, n) {
				...
				var s = function(t) {
					switch (t) {
						case e.CONFIRM_KEY: return a;
						case e.CANCEL_KEY: return i;
						default:
					...
					switch (t.length) {
						...
						case 2:
							...
							break;
						default: o.throwErr("Invalid number of 'buttons' in array (" + t.length + ").\n      If you want more than 2 buttons, you need to use an object!");
					}
					return n;
				};
			...
			function(t, e, n) {
				...
				e.initModalContent = function(t) {
					p(o.getNode(a), t), c.default(t.icon), l.initTitle(t.title), l.initText(t.text), f.default(t.content), u.default(t.buttons, t.dangerMode);
				};
				var m = function() {
			...
			function(t, e, n) {
				"use strict";
				Object.defineProperty(e, "__esModule", { value: !0 });
				e.modalMarkup = "\n  <div class=\"" + n(0).default.MODAL + "\" role=\"dialog\" aria-modal=\"true\"></div>", e.default = e.modalMarkup;
			},
			function(t, e, n) {
				"use strict";
				Object.defineProperty(e, "__esModule", { value: !0 });
			...
			function(t, e, n) {
				"use strict";
				Object.defineProperty(e, "__esModule", { value: !0 });
				var o = n(3), r = n(4), i = n(2), a = n(5), s = n(6), l = n(0).default.CONTENT, u = function(t) {
			...
			function(t, e, n) {
				...
				var o = n(5), r = n(6), i = n(1), a = n(3), s = n(0), c = s.default.MODAL, l = s.default.BUTTON, u = s.default.OVERLAY, f = function(t) {
					...
					if (o.default.isOpen) switch (t.key) {
						case "Escape": return r.onAction(a.CANCEL_KEY);
					}
				}, m = function(t) {
					if (o.default.isOpen) switch (t.key) {
						case "Tab": return f(t);
			...
			function(t, e, n) {
				...
				var l = function(t) {
					...
					var a = "string" === typeof e, s = e instanceof Element;
					if (a) {
			...
			function(t, e, n) {
				...
				e.getContentOpts = function(t) {
					return o.isPlainObject(t) ? Object.assign({}, t) : t instanceof Element ? { element: t } : "input" === t ? r : null;
				};
			},
			function(t, e, n) {
				"use strict";
